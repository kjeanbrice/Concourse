...
var DiscussionBoardComponent = /** @class */ (function () {
    ...
    DiscussionBoardComponent.prototype.populatePostEditor = function (event, option, delta) {
    ...
    DiscussionBoardComponent.prototype.onUpdate = function (event, name) {
        switch (name) {
