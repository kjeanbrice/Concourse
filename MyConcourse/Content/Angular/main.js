...
var DiscussionBoardService = /** @class */ (function () {
    function DiscussionBoardService(http_service) {
        this.http_service = http_service;
        this.discussionboard_id_source = new rxjs__WEBPACK_IMPORTED_MODULE_2__["BehaviorSubject"](-1);
        this.current_discussion_board = this.discussionboard_id_source.asObservable();
    }
    DiscussionBoardService.prototype.setDiscussionBoardID = function (new_discussionboard_id) {
        this.discussionboard_id_source.next(new_discussionboard_id);
    };
    DiscussionBoardService = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Injectable"])(),
        __metadata("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_1__["HttpClient"]])
